export default {
  ...
  'questions feed': 'лента вопросов',
  'knowledge base': 'база знаний',
  'knowledge base catalog': 'каталог базы знаний',
  'search in knowledge base': 'поиск в базе знаний',
  'search {w} in knowledge base': 'поиск {w} в базе знаний',
  'knowledge base bookmark': 'закладки базы знаний',
}
